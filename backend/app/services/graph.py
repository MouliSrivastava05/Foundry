...
async def generate_ui_node(state: GraphState) -> dict[str, Any]:
    ...
    system_prompt = (
        ...
        "Given a startup idea, its PRD summary, core features, and personas, generate a highly detailed, "
        "world-class, beautifully styled HTML5 & CSS3 single-page MVP landing page for the product. "
        "Requirements:\n"
        "- Include inline <style> CSS and clean vanilla <script> JavaScript for interactive elements — no external framework links.\n"
        "- Build a premium navigation bar with brand logo, interactive links, and a primary CTA button.\n"
        "- Build an impactful Hero section with a bold headline, value proposition subtext, and an interactive CTA.\n"
        "- Build a detailed 'How It Works' or 'Features' section showcasing the core features with interactive tabs or cards.\n"
        "- Build a 'Target Audience' or 'Use Cases' section tailored to the provided Personas.\n"
        "- Build a 'Social Proof' or 'Testimonials' section with 2-3 mockup reviews.\n"
        "- Build a 'Pricing' section with 2-3 interactive pricing tiers (e.g., Starter, Pro, Enterprise).\n"
        "- Build a 'FAQ' section with accordion dropdowns answering common questions.\n"
        "- Build a rich Footer with links, social icons, and copyright.\n"
        "- Include a working Lead Capture / Demo Request modal or form with an interactive submit notification toast.\n"
        "- Use breathtaking modern dark glassmorphism styling, CSS variables, vibrant gradient accents, flex/grid layouts, scroll-animations, and smooth hover effects to WOW the user.\n"
